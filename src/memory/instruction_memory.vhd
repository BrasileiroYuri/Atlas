...
architecture rtl of instruction_memory is
  ...
  signal mem : instruct_mem := (
      0 => "0000000" & "00010" & "00001" & "000" & "00011" & "0110011", -- ADD x3, x1, x2 (x3 = 2 + 2)
      1 => "0100000" & "00100" & "00101" & "000" & "00110" & "0110011", -- SUB x6, x5, x4 (x6 = x5 - x4)
      2 => "1000000" & "00000" & "00111" & "100" & "01111" & "0010011", -- NOT x15, x7
      3 => "0000000" & "01000" & "00001" & "111" & "01001" & "0110011", -- AND x9, x1, x8 (x9 = "10" and "11") = 2
      4 => "0000000" & "01000" & "00001" & "110" & "01011" & "0110011", -- OR x11, x1, x8 (x11 = "10" or "11") = 3
      5 => "0000000" & "00110" & "00011" & "000" & "10000" & "0110011", -- ADD x16, x3, x6
      6 => "000000000000" & "00000" & "010" & "11000" & "0000011", -- LD x22, 0(x0)
